...
public class GuiConstantsTest extends AssertTestCase {
	...
	public void testImagePaths() throws Exception {
		...
		assertEquals("resources/gui/buttons/playButtonImage.png",
				GuiConstants.PLAY_BUTTON_IMAGE_PATH);
		...
		assertEquals("resources/gui/buttons/stopButtonImage.png",
				GuiConstants.STOP_BUTTON_IMAGE_PATH);
	}
